      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
            Get in touch with our experts for a free consultation. We'll assess
            your needs and provide a customized electric fencing solution.
          </p>
        </div>
              ...
              <CardContent className="space-y-4 sm:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full p-3 rounded-md border border-border bg-background text-sm sm:text-base"
                  >
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-muted-foreground text-xs sm:text-sm">
                      Ground Floor, 12/355, KAROTTUKUNNEL Building
                      <br />
                      Velliyamattom, Thodupuzha
                      <br />
            ...
            <Card className="bg-gradient-to-br from-gold/5 to-gold/10 border-gold/20 shadow-card">
              <CardContent className="p-4 sm:p-6">
                <div className="text-center">
                  <h3 className="font-semibold text-gold mb-2 text-sm sm:text-base">
                    Authorized Dealer
                  </h3>
          ...
          <Card className="bg-gradient-to-r from-forest-dark to-primary border-0 text-white shadow-glow">
            <CardContent className="p-6 sm:p-8">
              ...
              <p className="mb-6 opacity-90 text-sm sm:text-base max-w-2xl mx-auto">
                Fence down? Wildlife breach? We provide 24/7 emergency repair
                services for critical wildlife and security installations.
              </p>
              <Button
                variant="hero"
                size="lg"
