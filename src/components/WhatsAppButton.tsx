...
const WhatsAppButton = () => {
  const phoneNumber = "919447022577"; // India country code + phone number
  const message = "Hello, I am interested in your electric fencing solutions. Please provide more information.";
